        ...
        <div className="pb-20 relative min-h-screen bg-[var(--bg-main)]">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div className="flex items-center gap-3">
                    <button onClick={() => navigate('/kyc-requests')} className="p-2 hover:bg-[var(--bg-box)] rounded-lg transition-colors text-[var(--text-second)] cursor-pointer">
                        <FiArrowLeft size={22} />
                    </button>
                    <div>
                        ...
                        {!selectedUser ? (
                            ...
                            <div className="bg-[var(--bg-main)] border border-[var(--bs-border)] rounded-xl p-4 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="p-2 hover:bg-[var(--bg-box)] rounded-lg text-[var(--icon-color)] hover:text-red-500 transition shadow-sm border border-transparent hover:border-(--bs-border) cursor-pointer"
                                    title="Remove User"
                                >
                                    <FiX size={18} />
                                </button>
