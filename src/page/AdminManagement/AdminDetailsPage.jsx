            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-2xl font-bold text-(--text-main)">Admin Details</h1>
                    </div>
                    <button
                        onClick={() => navigate(`${PathRoutes.ADD_ADMIN}?id=${admin._id || admin.id}`)}
                        className="flex items-center gap-2 px-4 py-2 border border-(--bs-primary) text-(--bs-primary) rounded-lg hover:bg-(--bs-primary) hover:text-white transition-all font-medium"
                    >
                        <FiEdit /> Edit Admin
                    </button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="col-span-1">
                        <div className="bg-(--bg-box) rounded-xl border border-(--bs-border) p-6 text-center shadow-sm">
                            ...
                            <p className="text-(--text-second) mb-3">{admin.email}</p>
